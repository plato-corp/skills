...
**REQUIRED for `craft`, `polish`, and `release`:** read [references/visual-completion.md](visual-completion.md). Its viewport attention contract, progressive-disclosure rule, severity model, and correction loop are release-blocking.
